...
export const MARKERS_ES: MarkerDefinition[] = [
  ...
  { text: 'se anunció que', role: 'necessity', language: 'es', priority: 8 },
  { text: 'anunció que', role: 'necessity', language: 'es', priority: 8 },
  { text: 'establece que', role: 'necessity', language: 'es', priority: 8 },
  { text: 'establecen que', role: 'necessity', language: 'es', priority: 8 },
  { text: 'afirma que', role: 'necessity', language: 'es', priority: 8 },
